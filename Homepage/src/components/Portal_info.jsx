  ...
  return (
    <div className="Portal_info h-[660px] pl-8 pr-8">
      ...
      <ol className="list-decimal">
        ...
        Resume Manager and Builder: Helps the students by giving them step-by-step instructions on how to build an impactful resume.
        </li>
        <li className="ml-4 pb-2">
        Profile Page: Guides students on how to create a strong profile on external platforms or media.
        </li>
        <li className="ml-4 pb-2">
        Student Relations: Gives the user an insight of the various “Student Relations” at the campus.
        </li>
        <li className="ml-4 pb-2">
        Student Clubs: Discusses about the various student activities and participation in the form of clubs. 
      </li>
      <li className="ml-4 pb-2">
      Placement Overview and Stats: Presents a data of past placement records and statistics to help students know about their opportunities.
      </li>
      <li className="ml-4 pb-2">
      Job Search: Based on the resume built, this portal helps students to find the best possible job for themselves, which is further discussed under the “Job Boarding” page.
      </li>
      <li className="ml-4 pb-2">
      Internship Finder: Provides the user with internships available in the market, based upon their individual interests.
      </li>
      </ol>
      </p>
    </div>
