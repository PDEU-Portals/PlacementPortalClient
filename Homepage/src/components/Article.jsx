...
export default function Article() {
  return (
    <div className="Article flex w-full h-auto pt-8 pb-12 bg-blue font-Poppins p-4">
      <div>
        <div class="Main_Card bg-white rounded-lg m-4 h-[93%] mt-6">
          ...
          <div class="Main_Card_Heading">
            ...
            <ul className="m-0 pl-4 pt-[10px]">
              <li className="blue_button_item blue_button p-[8px] inline-block bg-blue rounded mr-3  pl-3 border-solid border-[1px] border-blue hover:bg-white hover:text-blue">
                <a
                  href="#home"
