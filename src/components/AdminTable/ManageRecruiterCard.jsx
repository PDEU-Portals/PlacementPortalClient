...
const ManageRecruiterCard = () => {
  return (
    ...
    <Icon icon="ant-design:dislike-outlined" color="black" className=" mx-1 cursor-pointer text-5xl" /> */}
          <a href="/recruiter/companyprofile/:id">
            <button
              type="button"
              className="text-white bg-[#1F3368] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   self-center w-64 mt-1  "
            >
              Details
            </button>
          </a>
